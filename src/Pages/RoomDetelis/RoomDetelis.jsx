...
const RoomDetelis = () => {
    ...
    const handleConfirm = ()=>{
        const bookingData = {date,img,room_name,description}

        axios.post('http://localhost:5000/api/v1/bookingData',bookingData)
        .then(res=>{
     ...
     return (
        ...
        <h1 className="text-2xl font-bold">{room_name}</h1>
        ...
        <div className="w-1/2 border-l-2 pl-4 space-y-4 border-blue-600">
            <p><span className="text-2xl font-bold">Room Size</span> :  {room_size}</p>
                ...
                <button onClick={()=>handleBooking(_id)} className="btn bg-blue-600 text-white w-full">Book Now </button>
                </div>
            </div>
        </div>
        ...
        <dialog id="my_modal_1" className="modal">
                    <div className="modal-box  ">
                       ...
                       <div className="flex gap-2">
                        ...
                        <p><span className="text-xl font-bold">Price </span >:<span className="font-bold text-blue-700">${price_per_night}</span></p>

                        <p><span className="text-xl font-bold">Special offer</span> :  {special_offer}</p>
                     
                        <p><span className="text-xl font-bold">Room Description</span> :  {description}</p>
