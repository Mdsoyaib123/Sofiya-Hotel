...
const About = () => {
  ...
  <div className="hero-content gap-32 relative flex-col lg:flex-row">
        ...
        <img src="https://i.ibb.co/HrdjHk6/Getty-Images-1369095741-55-660x440.jpg" className="lg:w-1/2 rounded-lg shadow-2xl" />
        <div className=" lg:absolute bg-white px-5 pr-20  py-2 rounded-xl -left-14 bottom-20">
    ...
    <div>
      ...
      <button className="btn bg-blue-600 px-5 text-white">Read More </button>
    </div>
  </div>
</div>
    );
